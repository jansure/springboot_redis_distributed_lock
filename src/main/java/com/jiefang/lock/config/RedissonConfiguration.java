package com.jiefang.lock.config;
...
public class RedissonConfiguration {
    ...
    public RedissonClient redissonClient() {
        System.out.println("-------------redissonClient.start-------------");
        ...
        switch (redissonProperties.getModel()){
            case SINGLE:
                ...
                com.jiefang.lock.config.SingleServerConfig param = redissonProperties.getSingleServerConfig();
        ...
        System.out.println("-------------redissonClient.end-------------");
